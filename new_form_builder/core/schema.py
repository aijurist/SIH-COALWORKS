...
class FormFieldSchema(BaseModel):
    ...
    variant: str = Field(description='''The UI element type used for this field (allowed values are ["Checkbox", "Combobox", "Date Picker", "Datetime Picker", "File Input", "Input", "Multi Select", "Password", "Phone", "Select", "Signature Input", "Slider", "Switch", "Textarea"]).''', default="Input")
    ...
    options: Optional[List[Dict[str, str]]] = Field(description="List of dictionaries containing labels and values for option fields such as Checkbox, Select, Multi Select, Combobox.", default=None)
...
class FormSectionSchema(BaseModel):
    ...
    fields: List[FormFieldSchema] = Field(description="List of fields belonging to this section.", min_length=4)
...
class FormSchema(BaseModel):
    ...
    sections: List[FormSectionSchema] = Field(description="Organized sections of the form, each containing related fields.")